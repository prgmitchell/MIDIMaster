...
export function createDomRefs() {
  ...
  const virtualAudioRefresh = document.getElementById("virtual-audio-refresh");
  ...
  const virtualAudioDiagnosticsCounts = document.getElementById("virtual-audio-diagnostics-counts");
